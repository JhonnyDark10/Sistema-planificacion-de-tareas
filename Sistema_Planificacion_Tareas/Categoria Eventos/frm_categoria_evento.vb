...
Public Class frm_categoria_evento
    ...
    Private Sub btn_añadir_Click(sender As Object, e As EventArgs) Handles btn_añadir.Click
        ...
        Else
            Try
                sql = "INSERT INTO CATEGORIA_EVENTOS(DESCRIPCION, ESTADO_C_E) VALUES ("
    ...
    Private Sub btn_eliminar_Click(sender As Object, e As EventArgs) Handles btn_eliminar.Click
        Dim sql As String
        Try
            sql = "UPDATE CATEGORIA_EVENTOS SET ESTADO_C_E ='I' WHERE ID_CATEGORIA_EVENTOS= " & int_id_perfil
            Dim com As New SqlCommand(sql, mycon)
            Dim x As Integer
            x = com.ExecuteNonQuery
    ...
    Private Sub llenar_data_grip()
        ...
        Try
            sql = "select id_categoria_eventos as Codigo, descripcion As Registros from CATEGORIA_EVENTOS where estado_c_e = 'A'"
            Dim com As New SqlCommand(sql, mycon)
    ...
    Private Sub btn_modificar_Click(sender As Object, e As EventArgs) Handles btn_modificar.Click
        Dim sql As String
        Try
            sql = "UPDATE CATEGORIA_EVENTOS SET DESCRIPCION ='" & txt_ingresa_datos.Text & "' WHERE ID_CATEGORIA_EVENTOS= " & int_id_perfil
            Dim com As New SqlCommand(sql, mycon)
            Dim x As Integer
            x = com.ExecuteNonQuery
