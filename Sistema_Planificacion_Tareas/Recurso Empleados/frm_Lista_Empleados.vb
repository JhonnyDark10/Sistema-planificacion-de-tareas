...
Public Class frm_Lista_Empleados
    ...
    Private Sub frm_Lista_Empleados_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        llenar_data_grip()
    End Sub
    ...
    Private Sub dgv_cliente_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgv_cliente.CellDoubleClick
        Try
            If e.RowIndex > -1 Then
                ...
                'frm_modifica_empleado.ShowDialog()
                llenar_data_grip()
            End If
        Catch ex As Exception
            MsgBox(ex.Message)
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        Dim sql As String
        Try
            sql = "UPDATE participantes SET ESTADO_p ='I' WHERE dni_participantes= " & int_id_perfil
            Dim com As New SqlCommand(sql, mycon)
            Dim x As Integer
    ...
    Sub elimina_cuentas_usuario()
        Dim sql As String
            ...
            Try
            sql = "UPDATE seg_usuarios  SET usu_estado ='I' WHERE fk_empleados = " & int_id_perfil & " and usu_estado = 'A'"
